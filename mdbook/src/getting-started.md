...
Configure one provider transport before running `oneshot` or `proxy`. Provider-specific setup lives in [CLI Providers](./provider-cli.md) and [HTTP Providers](./provider-http.md).
